...
%changelog
* Thu Dec 15 2005 Kir Kolyshkin <kir-at-openvz.org> 1.0-3.swsoft
- added kernel-drm provides (needed for xorg-x11, bug #74)

* Tue Jun 21 2005 Kir Kolyshkin <kir-at-openvz.org> 1.0-2.swsoft
- added ethtool and /sbin/nash (required by initscripts)
